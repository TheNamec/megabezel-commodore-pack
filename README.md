...
* Currently I'm focusing on visual permutations for CRT TECHS (dot-mask, slot-mask, aperture grille, plasma), SIGNALS (RGB/SCART, S-VIDEO, COMPONENT, RF MODULATOR) and FLAVOURS (smooth, sharp, soft, more monochromes) 🤫
